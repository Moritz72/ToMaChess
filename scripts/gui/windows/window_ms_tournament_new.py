...
from PySide6.QtWidgets import QCheckBox, QHBoxLayout, QLineEdit, QMainWindow, QVBoxLayout, QWidget
from ..common.gui_functions import add_widgets_in_layout, add_widgets_to_layout, get_button, get_check_box, get_label, \
    get_lineedit, get_scroll_area_widgets_and_layouts, set_window_size, set_window_title
from ..widgets.widget_ms_tournament_stage_new import Widget_MS_Tournament_Stage_New_Generic, \
