...
from PySide6.QtWidgets import QHBoxLayout, QMainWindow, QTableWidget, QVBoxLayout, QWidget
from ..common.gui_functions import get_button, set_window_size, set_window_title
from ..common.gui_table import add_button_to_table, add_combobox_to_table, add_content_to_table, get_table_value, \
    set_up_table, size_table
from ...tournament.common.category_range import INTEGER_CATEGORIES, Category_Range
