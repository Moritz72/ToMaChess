...
from ..widgets.widget_menu_collections import Widget_Menu_Collections
from ..widgets.widget_menu_ms_tournament import Widget_Menu_MS_Tournament
from ..widgets.widget_menu_players import Widget_Menu_Players
from ..widgets.widget_menu_teams import Widget_Menu_Teams
from ..widgets.widget_menu_tournaments import Widget_Menu_Tournaments
from ..widgets.widget_settings import Widget_Settings
if TYPE_CHECKING:
