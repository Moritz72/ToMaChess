...
from PySide6.QtWidgets import QApplication, QCheckBox, QComboBox, QLabel, QLineEdit, QMainWindow, QPushButton, \
    QSpinBox, QVBoxLayout, QWidget
from .gui_functions import Widget_Size, connect_widget, get_check_box, get_combo_box, get_label, get_lineedit, \
    get_scroll_area_widgets_and_layouts, get_spin_box, set_fixed_size, set_font, set_window_title
from ...common.manager_translation import MANAGER_TRANSLATION
from ...tournament.parameters.parameter import Parameter
