...
ABOUT
	...
	For more information see https://github.com/Moritz72/ToMaChess.
...
BUILD FROM SOURCE
	The source code of this program is available at github.com/Moritz72/ToMaChess/releases.
	To build this program from source code, download the "Source code (zip)" or "Source code (tar.gz)" file of the appropriate release from the aformentioned url.
	Then, open the "build_from_source" folder and follow the instructions in "instructions.txt".
